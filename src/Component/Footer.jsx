    ...
    <footer class="bg-[#0b0e37] font-roboto pt-12 pb-8 px-12 tracking-wide relative overflow-hidden">
      <div class="max-w-screen-xl mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12 gap-8 z-20 relative">
          <div>
            <h2 class="text-lg text-gray-300 mb-6">Company</h2>
            <ul class="space-y-5">
              <li>
                <a
                  href="javascript:void(0)"
                  class="text-gray-400 hover:text-white text-base inline-flex items-center transition-all"
                >
                  <svg
                    ...
                    class="inline mr-1.5 h-4 w-4 shrink-0"
                  >
          ...
          <div>
            <h2 class="text-lg text-gray-300 mb-6">Products</h2>
            <ul class="space-y-5">
              <li>
                <a
                  href="javascript:void(0)"
          ...
          <div>
            <h2 class="text-lg text-gray-300 mb-6">Resources</h2>
            <ul class="space-y-5">
              <li>
                <a
                  href="javascript:void(0)"
          ...
          <div>
            <h2 class="text-lg text-gray-300 mb-6">Connect</h2>
            <ul class="space-y-5">
              <li>
                <a
                  href="javascript:void(0)"
        ...
        <div class="flex flex-wrap sm:justify-between gap-6 relative z-20">
          <div class="flex space-x-5">
            <a
              href="javascript:void(0)"
              class="text-gray-400 hover:text-white text-base inline-transition-all"
            >
              <svg
      ...
      <img
        ...
        class="absolute w-full inset-0 object-cover opacity-5 -z-0"
      />
    </footer>
    // <Container>
